...
![ASAC Data Science and Analytics schedule and delivery plan](course/assets/schedule.png)
...
Five words are used consistently across the schedule, this repository and every brief.

| Term | What it means |
|---|---|
| **Module** | A subject area, numbered 01 to 08. A module is not a week: module 02 spans several weeks, and week 8 draws on more than one module. Each module has a folder under [`modules/`](modules/) holding its content, labs, assignments, datasets and resources. |
| **Session** | One four-hour class, identified as D01 to D26. The identifier never changes, so D08 means the same session in every document. |
| **Lab** | Practice done in class to reinforce the concept just taught. It is not graded and does not become homework. If you do not finish, the reference solution is released at the debrief. |
| **Homework** | A weekly set issued in class and due before the first session of the following week. About 26 hours across the programme. There is no homework in week 8. |
| **Assignment** | Graded work done outside class, with a published brief, deadline and rubric. There are four: A1 to A4. |
| **Practical** | A graded, open-book assessment completed inside a session. There are two: P1 and P2. |

The third-party mock on D26 is separate from all of these. It informs the voucher decision and carries no course marks.

## Course coverage

| Module | Scheduled hours | Main focus |
|---|---:|---|
| [01 Data foundations](modules/01-data-foundations/) | 8 | Analyst roles, data quality, ethics and the Power BI workflow |
| [02 SQL and GitHub](modules/02-sql-and-github/) | 24 | Querying, joins, CTEs, window functions and portfolio workflow |
| [03 Power Query](modules/03-power-query/) | 16 | Importing, profiling, cleaning, combining and validating data |
| [04 Data modelling and DAX](modules/04-data-modeling-and-dax/) | 16 | Star schemas, relationships, measures, context and optimisation |
| [05 Visualisation and storytelling](modules/05-visualization-and-storytelling/) | 16 | Report design, accessibility, interaction and presentation |
| [06 Managing and securing Power BI](modules/06-power-bi-service/) | 4 | Publishing, workspaces, refresh and row-level security |
| [07 Machine learning and responsible AI](modules/07-machine-learning-and-ai/) | 12 | BigQuery ML, model evaluation, Python literacy and responsible use |
| [08 PL-300 review and career readiness](modules/08-pl300-and-career-readiness/) | 8 | Structured review, mock practice and next steps |
